...
ACCOUNT_EMAIL_CONFIRMATION_EXPIRE_DAYS = 0.010416

ACCOUNT_LOGIN_ON_EMAIL_CONFIRMATION = True

ACCOUNT_LOGOUT_ON_GET = True

ACCOUNT_EMAIL_CONFIRMATION_ANONYMOUS_REDIRECT_URL = 'accounts:profile_view'
...
# Redis, caching & ratelimiting settings.
